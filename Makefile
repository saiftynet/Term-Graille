# This Makefile is for the Term::Graille extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Term/Graille.pm]
#     AUTHOR => [q[Saif Ahmed]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[Artistic]
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Graphical Display in the terminal using UTF8 Braille characters'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Saif Ahmed'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'license: artistic' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: '\''1.4'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: Term-Graille' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Graphical Display in the terminal using UTF8 Braille characters",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Saif Ahmed"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '      "artistic_1"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	$(NOECHO) $(ECHO) '   "meta-spec" : {' >> META_new.json
	$(NOECHO) $(ECHO) '      "url" : "http://search.cpan.org/perldoc?CPAN::Meta::Spec",' >> META_new.json
	$(NOECHO) $(ECHO) '      "version" : 2' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Term-Graille",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "url" : "https://github.com/saiftynet/Term-Graille.git",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Term-Graille" VERSION="0.05">' > Term-Graille.ppd
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.30" />' >> Term-Graille.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Term-Graille.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Term-Graille.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Term-Graille.ppd
